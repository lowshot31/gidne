...
export default function TickerStripClient() {
  ...
  if (error || !data) {
    return <div className="ticker-strip" style={{ padding: '10px 1.5rem', background: 'rgba(15, 15, 20, 0.9)', borderBottom: '1px solid var(--border-color)', color: 'var(--bear)' }}>⚠️ 백그라운드 서버 확인 중...</div>;
  }
